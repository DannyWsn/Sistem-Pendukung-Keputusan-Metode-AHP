...
class Subkriteria extends CI_Controller
{
    ...
    public function create_action()
    {
        ...
        $this->Subkriteria_model->subkriteria_add($id_kriteria, $nama_subkriteria);
    ...
    public function update_action()
    {
        ...
        $this->form_validation->set_rules('nama_subkriteria', 'Sub Kriteria', 'required');
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($this->Subkriteria_model->subkriteria_edit($subID, $id_kriteria, $nama_subkriteria) == TRUE) {
